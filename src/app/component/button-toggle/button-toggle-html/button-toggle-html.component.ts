...
export class ButtonToggleHtmlComponent {
  htmlButtonToggleConfig = {
    componentProperty: {
      options: [
        { value: 'Bold', viewValue: 'Bold', icon: 'format_bold' },
        {
          value: 'Italic',
          viewValue: 'Italic',
          icon: 'format_italic',
  ...
  buttonClickEvent() {
    this.angularCodeTemplateViewModel.tsConfig =
      AngularCodeTemplate.Button_Toggle_OnHtml_TS_KEY;
    this.angularCodeTemplateViewModel.htmlConfig =
      AngularCodeTemplate.Button_Toggle_OnHtml_HTML_KEY;
