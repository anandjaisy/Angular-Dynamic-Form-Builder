...
export class RadioHtmlComponent implements OnInit {
  ...
  buttonClickEvent() {
    this.angularCodeTemplateViewModel.tsConfig = AngularCodeTemplate.Radios_OnHtml_TS_KEY;
    this.angularCodeTemplateViewModel.htmlConfig = AngularCodeTemplate.Radio_OnHtml_HTML_KEY;
