...
export class SelectComponent extends BaseFormComponent<any> implements OnInit {
  ...
  ngOnInit(): void {
    ...
    setTimeout(() => {
      this.patchValue(
        {
          multipleMatSelect: [this.controlsConfig.container.layoutConfig[0].componentConfig[1].componentProperty.options[6].disabled = true],
          disableMatSelect: this.controlsConfig.container.layoutConfig[0].componentConfig[2].componentProperty.disabled = true,
          defaultValueMatSelect: this.controlsConfig.container.layoutConfig[0].componentConfig[3].componentProperty.value = 'pepperoni'
        }
      )
